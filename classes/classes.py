...
class DBManager(DBConnector):
    ...
    def get_all_vacancies(self):
        ...
        [print(
            f'Вакансия: {i[0]}\t|\t'
            f'Компания: {i[1]}\t|\t'
            f'Заработная плата: {"не указана" if not i[2] else i[2]}\t|\t'
    ...
    def get_vacancies_with_higher_salary(self):
        ...
        [print(
            ...
            f'Заработная плата: {"не указана" if not i[3] else i[3]}\t|\t'
    ...
    def get_employers(cls, user_input: tuple) -> list[tuple] | None:
        ...
        for page in range(50):  # чтение 50 страниц по 100 вакансий
            ...
            for employer in one_page_data['items']:
                ...
                if vacancies_find >= cls._max_vacancies:
                    break
            if one_page_data['pages'] <= page:
                break  # проверка достижения последней страницы поиска
